...
public class DialogAuthService {
    ...
    //        this.INVALID_DIALOG = Holder.direct(provider.get(String.format("%s:login/invalid",
    // TekohaAdditions.MOD_ID)));
    //        this.LOGIN_DIALOG = Holder.direct(provider.get(String.format("%s:login/login", TekohaAdditions.MOD_ID)));
    //        this.SIGNUP_DIALOG = Holder.direct(provider.get(String.format("%s:login/signup",
    // TekohaAdditions.MOD_ID)));
    //    }
    //
    //    @Override
